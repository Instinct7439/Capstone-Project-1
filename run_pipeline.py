...
PIPELINE_STEPS = [
    ...
    },
    {
        ...
        "script": "db_loader.py",
        "description": "Builds SQLite star schema (bluestock_mf.db) and loads dimension and fact tables."
    },
    {
...
def main() -> None:
    ...
    print(f" Output Artifacts   : bluestock_mf.db, rolling_sharpe_chart.png, reports/day1_data_quality_summary.md")
    print("=" * 90 + "\n")
