...
def calculate_rolling_sharpe(db_path: str = None) -> pd.DataFrame:
    """
    ...
    if db_path is None or not os.path.exists(db_path):
        ...
        possible_paths = [
            os.path.join(root_dir, "data", "db", "bluestock_mf.db"),
            os.path.join(root_dir, "bluestock_mf.db"),
        ...
        for p in possible_paths:
            ...
            db_path = os.path.join(root_dir, "data", "db", "bluestock_mf.db")
...
def plot_rolling_sharpe(df_plot: pd.DataFrame) -> None:
    ...
    root_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
    output_file = os.path.join(root_dir, "rolling_sharpe_chart.png")
    plt.savefig(output_file, dpi=300, bbox_inches="tight")

    exported_dir = os.path.join(root_dir, "dashboard", "exported_charts")
